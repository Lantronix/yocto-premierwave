...
SRC_URI = "${SOURCEFORGE_MIRROR}/net-snmp/net-snmp-${PV}.tar.gz \
           ...
           file://netsnmp-001-bridging-myaddr.patch \
           file://netsnmp-002-fips.patch \
           "
...
#PACKAGECONFIG[ribnl] = "--with-nl, --without-nl, libnl"

#PACKAGECONFIG[ipv6] = "--enable-ipv6,--disable-ipv6,,"

PACKAGECONFIG[perl] = "--enable-embedded-perl --with-perl-modules=yes, --disable-embedded-perl --with-perl-modules=no,\
                       perl, perl perl-lib"
# Add "--disable-debugging" option to EXTRA_OECONF before commiting the changes
EXTRA_OECONF = "--enable-shared \
                --disable-manuals \
                --with-defaults --disable-debugging \
                ...
                --enable-mini-agent --without-rpm \
                --with-logfile=none --enable-as-needed \
                --disable-scripts --without-kmem-usage \
                --enable-silent-libtool --enable-mfd-rewrites \
                --with-out-transports="Unix" \
                --with-openssl=${STAGING_INCDIR}/usr/include/openssl \
                --with-mib-modules="host ucd-snmp/dlmod \
                                    if-mib tcp-mib udp-mib ip-mib \
                                    mibII/icmp mibII/kernel_linux mibII/tcp \
                                    mibII/ip mibII/udp mibII/icmp mibII/at mibII/ifTable \
                                    mibII/ipAddr mibII/ipv6 mibII/tcpTable mibII/udpTable \
                                    tcp-mib/tcpConnectionTable \
                                    ucd-snmp/pass ucd-snmp/extensible agent/extend agentx" \
...
EXTRA_OECONF += "--with-out-mib-modules="disman/event disman/schedule utilities mibII/system_mib""
...
RDEPENDS_${PN}-libs += "libpcre"
#RDEPENDS_${PN}-libs += "libpcap"
#RDEPENDS_${PN}-libs += "ncurses-libncurses"
#RDEPENDS_${PN}-libs += "ncurses-libtinfo"
