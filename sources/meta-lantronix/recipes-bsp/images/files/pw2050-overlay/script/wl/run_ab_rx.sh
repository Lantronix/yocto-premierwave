...
then
  echo "Usage: band BW channel rate macColon nvram_location time antenna"
  echo "normal value: a 40 36 8 00:00:88:c0:ff:ee /lib/modules/firmware/bcmdhd.cal 10 3"
  echo "normal value: b 20 6 7 00:00:88:c0:ff:ee /lib/modules/firmware/bcmdhd.cal 10 1"
  echo "normal value: bl 20 6 54 00:00:88:c0:ff:ee /lib/modules/firmware/bcmdhd.cal 10 0"
  exit -1
fi
...
$script_dir/wl_x up
$script_dir/wl_x txchain 1
$script_dir/wl_x rxchain 1
...
#$script_dir/wl_x pkteng_start 00:00:88:c0:ff:ee rx
$script_dir/wl_x pkteng_start $5 rx
$script_dir/wl_x counters

echo "Getting Packet 1"
echo " Wait for $7 seconds"
sleep $7

$script_dir/wl_x counters
echo "Getting Packet 2"
#$script_dir/wl_x phy_rxiqest
#$script_dir/wl_x pkteng_stats

#$script_dir/wl_x pkteng_stop rx
