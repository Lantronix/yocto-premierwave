...
DEPENDS = "docbook-utils-native sgmlspl-native busybox openssl"
...
do_compile () {
	oe_runmake 'CC=${CC} -D_GNU_SOURCE' USE_GNUTLS=no USE_CAP=no USE_SYSFS=no VPATH="${STAGING_LIBDIR}:${STAGING_DIR_HOST}/${base_libdir}" all man
}
